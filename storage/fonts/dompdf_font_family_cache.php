<?php return array (
  ...
  'ipagp' => array(
    'normal' => $rootDir . '/lib/fonts/ipagp',
    'bold' => $rootDir . '/lib/fonts/ipagp',
    'italic' => $rootDir . '/lib/fonts/ipagp',
    'bold_italic' => $rootDir . '/lib/fonts/ipagp',
  ),
  'ms-gothic' => array(
    'normal' => $fontDir . '/MS-Gothic',
    'bold' => $fontDir . '/MS-Gothic',
    'italic' => $fontDir . '/MS-Gothic',
    'bold_italic' => $fontDir . '/MS-Gothic',
  ),
    'meiryoui' => array(
        'normal' => $fontDir . '/MeiryoUI_M',
        'bold' => $fontDir . '/MeiryoUI_M',
        'italic' => $fontDir . '/MeiryoUI_M',
        'bold_italic' => $fontDir . '/MeiryoUI_M',
    ),
) ?>
